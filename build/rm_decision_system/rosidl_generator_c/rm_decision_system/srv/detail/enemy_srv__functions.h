...
#ifndef RM_DECISION_SYSTEM__SRV__DETAIL__ENEMY_SRV__FUNCTIONS_H_
#define RM_DECISION_SYSTEM__SRV__DETAIL__ENEMY_SRV__FUNCTIONS_H_
...
/// Initialize srv/EnemySrv message.
/**
...
/// Create srv/EnemySrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_decision_system__srv__EnemySrv_Request__init().
...
/// Destroy srv/EnemySrv message.
/**
 * It calls
 * rm_decision_system__srv__EnemySrv_Request__fini()
...
/// Check for srv/EnemySrv message equality.
/**
...
/// Initialize array of srv/EnemySrv messages.
/**
...
/// Finalize array of srv/EnemySrv messages.
/**
 * It calls
 * rm_decision_system__srv__EnemySrv_Request__fini()
...
/// Create array of srv/EnemySrv messages.
/**
 * It allocates the memory for the array and calls
 * rm_decision_system__srv__EnemySrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/EnemySrv messages.
/**
 * It calls
 * rm_decision_system__srv__EnemySrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/EnemySrv message array equality.
/**
...
/// Copy an array of srv/EnemySrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_decision_system__srv__EnemySrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_decision_system
...
/**
 * It calls
 * rm_decision_system__srv__EnemySrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_decision_system
...
/**
 * It allocates the memory for the array and calls
 * rm_decision_system__srv__EnemySrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_decision_system
...
/**
 * It calls
 * rm_decision_system__srv__EnemySrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RM_DECISION_SYSTEM__SRV__DETAIL__ENEMY_SRV__FUNCTIONS_H_
