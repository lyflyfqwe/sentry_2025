...
#include "robot_decision_system/srv/detail/nav_srv__rosidl_typesupport_fastrtps_c.h"
...
#include "robot_decision_system/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _NavSrv_Request__ros_msg_type = robot_decision_system__srv__NavSrv_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_decision_system
size_t get_serialized_size_robot_decision_system__srv__NavSrv_Request(
  const void * untyped_ros_message,
...
static uint32_t _NavSrv_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_decision_system__srv__NavSrv_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_decision_system
size_t max_serialized_size_robot_decision_system__srv__NavSrv_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_decision_system__srv__NavSrv_Request;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
static size_t _NavSrv_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_decision_system__srv__NavSrv_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_decision_system, srv, NavSrv_Request)() {
...
using _NavSrv_Response__ros_msg_type = robot_decision_system__srv__NavSrv_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_decision_system
size_t get_serialized_size_robot_decision_system__srv__NavSrv_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavSrv_Response__ros_msg_type * ros_message = static_cast<const _NavSrv_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_decision_system__srv__NavSrv_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_decision_system
size_t max_serialized_size_robot_decision_system__srv__NavSrv_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_decision_system__srv__NavSrv_Response;
    is_plain =
      (
...
static size_t _NavSrv_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_decision_system__srv__NavSrv_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_decision_system, srv, NavSrv_Response)() {
...
// already included above
// #include "robot_decision_system/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_decision_system/srv/nav_srv.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_decision_system, srv, NavSrv)() {
