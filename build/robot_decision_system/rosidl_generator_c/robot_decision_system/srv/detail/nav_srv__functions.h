...
#ifndef ROBOT_DECISION_SYSTEM__SRV__DETAIL__NAV_SRV__FUNCTIONS_H_
#define ROBOT_DECISION_SYSTEM__SRV__DETAIL__NAV_SRV__FUNCTIONS_H_
...
#include "robot_decision_system/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_decision_system
bool
 ...
 * calls
 * robot_decision_system__srv__NavSrv_Request__init().
...
/**
 * It calls
 * robot_decision_system__srv__NavSrv_Request__fini()
 ...
 * robot_decision_system__srv__NavSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_decision_system__srv__NavSrv_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_decision_system__srv__NavSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_decision_system
...
/**
 * It calls
 * robot_decision_system__srv__NavSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_decision_system
...
/**
 * It allocates the memory for the array and calls
 * robot_decision_system__srv__NavSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_decision_system
...
/**
 * It calls
 * robot_decision_system__srv__NavSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_DECISION_SYSTEM__SRV__DETAIL__NAV_SRV__FUNCTIONS_H_
