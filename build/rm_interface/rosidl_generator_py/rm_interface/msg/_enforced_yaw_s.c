...
bool rm_interface__msg__enforced_yaw__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_interface.msg._enforced_yaw.EnforcedYaw", full_classname_dest, 42) == 0);
  }
  rm_interface__msg__EnforcedYaw * ros_message = _ros_message;
  {  // flag
  ...
  {  // spin
    ...
    ros_message->spin = (Py_True == field);
    Py_DECREF(field);
  }
  {  // ahead
...
{
  /* NOTE(esteve): Call constructor of EnforcedYaw */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_interface.msg._enforced_yaw");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EnforcedYaw");
  ...
  {  // spin
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->spin ? 1 : 0);
    {
