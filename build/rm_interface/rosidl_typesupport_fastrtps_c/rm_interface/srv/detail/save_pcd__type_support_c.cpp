...
#include "rm_interface/srv/detail/save_pcd__rosidl_typesupport_fastrtps_c.h"
...
using _SavePCD_Request__ros_msg_type = rm_interface__srv__SavePCD_Request;
...
size_t get_serialized_size_rm_interface__srv__SavePCD_Request(
  const void * untyped_ros_message,
...
static uint32_t _SavePCD_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interface__srv__SavePCD_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interface
size_t max_serialized_size_rm_interface__srv__SavePCD_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interface__srv__SavePCD_Request;
    is_plain =
      (
...
static size_t _SavePCD_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interface__srv__SavePCD_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD_Request)() {
...
using _SavePCD_Response__ros_msg_type = rm_interface__srv__SavePCD_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interface
size_t get_serialized_size_rm_interface__srv__SavePCD_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SavePCD_Response__ros_msg_type * ros_message = static_cast<const _SavePCD_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interface__srv__SavePCD_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interface
size_t max_serialized_size_rm_interface__srv__SavePCD_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rm_interface__srv__SavePCD_Response;
    is_plain =
      (
...
static size_t _SavePCD_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interface__srv__SavePCD_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD_Response)() {
...
// already included above
// #include "rm_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "rm_interface/srv/save_pcd.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD)() {
