...
static const _SetRobotMode_Request_type_support_symbol_names_t _SetRobotMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SetRobotMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SetRobotMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SetRobotMode_Request)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SetRobotMode_Request_message_type_support_handle;
}
...
static const _SetRobotMode_Response_type_support_symbol_names_t _SetRobotMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SetRobotMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SetRobotMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SetRobotMode_Response)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SetRobotMode_Response_message_type_support_handle;
}
...
static const _SetRobotMode_type_support_symbol_names_t _SetRobotMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SetRobotMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SetRobotMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SetRobotMode)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SetRobotMode_service_type_support_handle;
}
