...
static const _SavePCD_Request_type_support_symbol_names_t _SavePCD_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SavePCD_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SavePCD_Request)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SavePCD_Request_message_type_support_handle;
}
...
static const _SavePCD_Response_type_support_symbol_names_t _SavePCD_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SavePCD_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SavePCD_Response)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SavePCD_Response_message_type_support_handle;
}
...
static const _SavePCD_type_support_symbol_names_t _SavePCD_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interface, srv, SavePCD)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interface, srv, SavePCD)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rm_interface, srv, SavePCD)() {
  return &::rm_interface::srv::rosidl_typesupport_c::SavePCD_service_type_support_handle;
}
