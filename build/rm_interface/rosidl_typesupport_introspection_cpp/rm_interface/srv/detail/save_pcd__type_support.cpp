...
{
  new (message_memory) rm_interface::srv::SavePCD_Request(_init);
}

void SavePCD_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interface::srv::SavePCD_Request *>(message_memory);
  typed_message->~SavePCD_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SavePCD_Request_message_member_array[1] = {
  {
    "file_path",  // name
    ...
    offsetof(rm_interface::srv::SavePCD_Request, file_path),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SavePCD_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rm_interface::srv::SavePCD_Request),
...
{
  return &::rm_interface::srv::rosidl_typesupport_introspection_cpp::SavePCD_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interface, srv, SavePCD_Request)() {
  return &::rm_interface::srv::rosidl_typesupport_introspection_cpp::SavePCD_Request_message_type_support_handle;
}
...
void SavePCD_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rm_interface::srv::SavePCD_Response(_init);
}

void SavePCD_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interface::srv::SavePCD_Response *>(message_memory);
  typed_message->~SavePCD_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SavePCD_Response_message_member_array[3] = {
  {
    "memory_gb",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interface::srv::SavePCD_Response, memory_gb),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interface::srv::SavePCD_Response, point_num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interface::srv::SavePCD_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SavePCD_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(rm_interface::srv::SavePCD_Response),
...
{
  return &::rm_interface::srv::rosidl_typesupport_introspection_cpp::SavePCD_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interface, srv, SavePCD_Response)() {
  return &::rm_interface::srv::rosidl_typesupport_introspection_cpp::SavePCD_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SavePCD_service_members = {
  ...
  // see get_service_type_support_handle<rm_interface::srv::SavePCD>()
...
get_service_type_support_handle<rm_interface::srv::SavePCD>()
{
  ...
  auto service_type_support =
    &::rm_interface::srv::rosidl_typesupport_introspection_cpp::SavePCD_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interface, srv, SavePCD)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rm_interface::srv::SavePCD>();
}
