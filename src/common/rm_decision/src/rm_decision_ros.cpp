...
public:
    ...
    //     Visual::loadParamToRegion<double>("decision.region.first", decision_->regions_[Regions::FIRST], this,{
    //         -10.06, -6.89, -0.14,
    //  -10.01, -7.61, -0.27, 
    //  -11.14, -7.52, -0.27, 
    //  -11.70, -6.92, -0.27
    //  });
    //  auto points_first = decision_->regions_[Regions::FIRST].getPoints();
