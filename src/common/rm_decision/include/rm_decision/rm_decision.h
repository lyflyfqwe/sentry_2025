...
public:
    enum TYPE{GUARD, GUARDS, GUARDT, CURE, TOWER, PLACE, FIRST, SECOND, THIRD};
...
private:
    ...
    std::atomic<Regions::TYPE> robot_state_{Regions::TOWER};
...
public:
    ...
    struct DecisionConfig{
        struct Nav{
            ...
            Eigen::Vector3d attact_tower_pos{ 1.95, 2.02, -0.07 };
        }nav;
