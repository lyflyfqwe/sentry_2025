#ifndef PATH_MOTION_PLANNING_PATH_SEARCHER_THETA_STAR_ASSIST_H
#define PATH_MOTION_PLANNING_PATH_SEARCHER_THETA_STAR_ASSIST_H

#include "path_motion_planning/path_searcher/path_searcher.h"

namespace path_motion_planning{
namespace path_searcher{
class ThetaStarAssist: public PathSearcher{
private:
...
public:
    ...
    typedef std::shared_ptr<ThetaStarAssist> Ptr;

    ThetaStarAssist(altitude_map::AltitudeMap::Ptr& map, double w_travel, long long max_cal_num_limit);
