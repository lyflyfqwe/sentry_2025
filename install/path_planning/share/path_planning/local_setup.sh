...
: ${AMENT_CURRENT_PREFIX:="/home/sentry-nov/code/colcon_3/install/path_planning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/path_planning/environment/library_path.sh"
