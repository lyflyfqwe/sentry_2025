#ifndef UTIL_VIS_ROS_H
#define UTIL_VIS_ROS_H
...
protected:
    ...
    void pubArray(rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr& pub, rclcpp::Node* node,
            const Eigen::Vector3d& p, const Eigen::Quaterniond& q){
        visualization_msgs::msg::Marker marker;  
        marker.header.frame_id = "map"; // 设置参考框架  
