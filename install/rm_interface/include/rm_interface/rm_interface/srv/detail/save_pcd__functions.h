...
#ifndef RM_INTERFACE__SRV__DETAIL__SAVE_PCD__FUNCTIONS_H_
#define RM_INTERFACE__SRV__DETAIL__SAVE_PCD__FUNCTIONS_H_
 ...
 * calls
 * rm_interface__srv__SavePCD_Request__init().
...
/**
 * It calls
 * rm_interface__srv__SavePCD_Request__fini()
 ...
 * rm_interface__srv__SavePCD_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_interface__srv__SavePCD_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rm_interface__srv__SavePCD_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interface
...
/**
 * It calls
 * rm_interface__srv__SavePCD_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interface
...
/**
 * It allocates the memory for the array and calls
 * rm_interface__srv__SavePCD_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interface
...
/**
 * It calls
 * rm_interface__srv__SavePCD_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RM_INTERFACE__SRV__DETAIL__SAVE_PCD__FUNCTIONS_H_
