...
rm_interface__srv__SetRobotMode_Request__are_equal(const rm_interface__srv__SetRobotMode_Request * lhs, const rm_interface__srv__SetRobotMode_Request * rhs)
{
  ...
  // robot_speed_rate
  if (lhs->robot_speed_rate != rhs->robot_speed_rate) {
    return false;
  }
  return true;
}
  ...
  rm_interface__srv__SetRobotMode_Request * output)
{
  ...
  // robot_speed_rate
  output->robot_speed_rate = input->robot_speed_rate;
  return true;
}
...
rm_interface__srv__SetRobotMode_Request__create()
{
  ...
  rm_interface__srv__SetRobotMode_Request * msg = (rm_interface__srv__SetRobotMode_Request *)allocator.allocate(sizeof(rm_interface__srv__SetRobotMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_interface__srv__SetRobotMode_Request));
  bool success = rm_interface__srv__SetRobotMode_Request__init(msg);
  if (!success) {
...
rm_interface__srv__SetRobotMode_Request__destroy(rm_interface__srv__SetRobotMode_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_interface__srv__SetRobotMode_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_interface__srv__SetRobotMode_Request__Sequence__init(rm_interface__srv__SetRobotMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interface__srv__SetRobotMode_Request * data = NULL;

  if (size) {
    data = (rm_interface__srv__SetRobotMode_Request *)allocator.zero_allocate(size, sizeof(rm_interface__srv__SetRobotMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_interface__srv__SetRobotMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_interface__srv__SetRobotMode_Request__fini(&data[i - 1]);
      }
...
rm_interface__srv__SetRobotMode_Request__Sequence__fini(rm_interface__srv__SetRobotMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_interface__srv__SetRobotMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interface__srv__SetRobotMode_Request__Sequence * array = (rm_interface__srv__SetRobotMode_Request__Sequence *)allocator.allocate(sizeof(rm_interface__srv__SetRobotMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_interface__srv__SetRobotMode_Request__Sequence__init(array, size);
  if (!success) {
...
rm_interface__srv__SetRobotMode_Request__Sequence__destroy(rm_interface__srv__SetRobotMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_interface__srv__SetRobotMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_interface__srv__SetRobotMode_Request__Sequence__are_equal(const rm_interface__srv__SetRobotMode_Request__Sequence * lhs, const rm_interface__srv__SetRobotMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_interface__srv__SetRobotMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_interface__srv__SetRobotMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_interface__srv__SetRobotMode_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_interface__srv__SetRobotMode_Request * data =
      (rm_interface__srv__SetRobotMode_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interface__srv__SetRobotMode_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_interface__srv__SetRobotMode_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_interface__srv__SetRobotMode_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interface__srv__SetRobotMode_Response * msg = (rm_interface__srv__SetRobotMode_Response *)allocator.allocate(sizeof(rm_interface__srv__SetRobotMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_interface__srv__SetRobotMode_Response));
  bool success = rm_interface__srv__SetRobotMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
rm_interface__srv__SetRobotMode_Response__destroy(rm_interface__srv__SetRobotMode_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_interface__srv__SetRobotMode_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_interface__srv__SetRobotMode_Response__Sequence__init(rm_interface__srv__SetRobotMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interface__srv__SetRobotMode_Response * data = NULL;

  if (size) {
    data = (rm_interface__srv__SetRobotMode_Response *)allocator.zero_allocate(size, sizeof(rm_interface__srv__SetRobotMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_interface__srv__SetRobotMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rm_interface__srv__SetRobotMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
rm_interface__srv__SetRobotMode_Response__Sequence__fini(rm_interface__srv__SetRobotMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_interface__srv__SetRobotMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interface__srv__SetRobotMode_Response__Sequence * array = (rm_interface__srv__SetRobotMode_Response__Sequence *)allocator.allocate(sizeof(rm_interface__srv__SetRobotMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_interface__srv__SetRobotMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
rm_interface__srv__SetRobotMode_Response__Sequence__destroy(rm_interface__srv__SetRobotMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_interface__srv__SetRobotMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_interface__srv__SetRobotMode_Response__Sequence__are_equal(const rm_interface__srv__SetRobotMode_Response__Sequence * lhs, const rm_interface__srv__SetRobotMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_interface__srv__SetRobotMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_interface__srv__SetRobotMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_interface__srv__SetRobotMode_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_interface__srv__SetRobotMode_Response * data =
      (rm_interface__srv__SetRobotMode_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interface__srv__SetRobotMode_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_interface__srv__SetRobotMode_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_interface__srv__SetRobotMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
